...
// import TemplateTwo from '../resume-pdf/templates/templateTwo/TemplateTwo'
// import TemplateOne from '../resume-pdf/templates/templateOne/TemplateOne'
// import TemplateThree from '../resume-pdf/templates/templateThree/TemplateThree'

// const ResumeComponent = ({ match, location }) => {
...
// 			await axios
// 				.get(`http://localhost:3001/api/${match.params.id}`)
// 				.then(res => {
// 					if (res.data.success) {
// 						setMounted(true)
...
// 					style={{ height: '100vh' }}
// 				>
// 					{location.state.templateId === 1 ? (
// 						<TemplateOne userResumeData={userResumeData} />
// 					) : location.state.templateId === 2 ? (
// 						<TemplateTwo userResumeData={userResumeData} />
// 					) : (
// 						<TemplateThree userResumeData={userResumeData} />
// 					)}
// 				</PDFViewer>
// 			) : (
